const qoutes = [
  "  اللهُم خَبراً جميلاً ، ودعوة مستجابة",
  "ولا يعلمُ مافي قلبك الاّ ربّك ف إلجأ اليه مُرتاح النفس و مطمئن الروح",
  "الحمد لله ماضاق أمرٌ إلا هان",
  "وأكتب لنا الخير كُل الخير ياربّ.",
  "ولنثق دائماً بأنّ الله كله خير وبأنّ مشيئته كلها رحمة.",
  "كل كسر ألجأك إلى الله ، هو جبرٌ وإن أوجعك",
  "(اللهم اكفني بحلالك عن حرامك، و أغْنِني بفضلك عمن سواك).",
  " مَاتراكَمتْ إلا لتُمطر ",
  "لُطف الله يحميك وأنت لا تعلم",
  "هوّن عليك فإن الأمور بكفِّ الإله مقاديرها 💚",
  "إنَّ المرءَ ليُرزَقُ السَّكينةَ بكثرَةِ لجُوئهِ إلى الله 💚",
  "أعرف ولا تنسى.. إن الله لا يكلف نفساً إلا وسعها",
  "من يحب الله يرى كل شيء جميلاً",
  "كن كالغيث أينما وقع نفع. 💙",
  "لاتتراجع ابداً ، النجاح العظيم يستغرق وقتاً 💙",
  "خبايا الله العظيمة لا تأتي إلّا بعد أن يُختبر صَبرُك❤️",
  "قَدْ أُوتِيتَ سُؤْلَكَ إستجاب واللي نفسك فيه خلاص هيكون حقيقة قول يارب❤️",
  "سيعوضك عن إنطفاء قلبك ابشر 😍",
  "تظُن أنهُ سيُرضيك ؛فيُعطيك ضعف ظنّك 🤍",
  "تظنه استثناك من جبره في حين إنه يجهز لك، ما يروي قلبك وروحك.. قل يارب❤️",
  "فكُن علَى ثقَه بِالله دائمًا ، ستأتِي بَعدَ زحام البلاء أفراح 😍",
  "۞ وَبَشِّرِ الصَّابِرِين ۞❤️",
  "قاوم، لا زال في الحياة مُتسع لتحلم 💚",
  "اللهم حقلًا من فرح  يُزهر بين حنايا القلب ويُثمر💚",
  "سيأتيك الله ب جبر تندمُ فيهِ عن يأسك لِتعلم أنَّ وعدَ اللهِ حق .. 💙",
  "اقترب موعد الاستجابه ، وسيرزقك اللّه ليله لن تنام فيها من شدة فرحتك .. ابشر",
  "لأن الله يريد ذلك، فلا تقل مستحيل إنما أمره إذا أراد شيئاً أن يقول له كن فيكون❤️",
